...
\newcommand{\abstractblock}{$if(pdf_abstract)$
$if(titlepage-theme.abstract-color)$\textcolor{$titlepage-theme.abstract-color$}$endif${$if(titlepage-theme.abstract-align)$\titlepageabstractalign
$endif$$if(titlepage-theme.abstract-fontfamily)$\titlepageabstractfont
$endif$\titlepageabstractblock}

\vspace{$if(titlepage-theme.abstract-space-after)$$titlepage-theme.abstract-space-after$$else$0pt$endif$}
$else$$endif$}

\newcommand{\titlepageabstractblock}{$if(pdf_abstract)$
\vspace*{1cm}\begin{tabular}{m{$titlepage-theme.abstract-width-scale$\textwidth}}
\hline\\
{$pdf_abstract$}\\
\hline\\
\end{tabular}
