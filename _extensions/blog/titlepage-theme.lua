...
--]]
    ...
    ["blog"] = function (m)
      themevals = {
        ["elements"] = {
          ...
          pandoc.MetaInlines{pandoc.RawInline("latex","\\abstractblock")},
  ...
  okvals = {"plain", "vline", "vline-text", "bg-image", "colorbox", "blog", "academic", "formal", "classic-lined"}
