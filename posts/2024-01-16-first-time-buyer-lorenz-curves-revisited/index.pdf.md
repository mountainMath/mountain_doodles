...
::: {.cell-output-display}
![](index_files/figure-pdf/calgary-ftb-1.png){fig-pos='H'}
:::
:::
...
::: {.cell-output-display}
![](index_files/figure-pdf/ftb-updated-1.png){fig-pos='H'}
:::
:::
...
::: {.cell-output-display}
![](index_files/figure-pdf/prop-tax-effect-1.png){fig-pos='H'}
:::
:::
...
::: {.cell-output-display}
![](index_files/figure-pdf/ftb-pt-1.png){fig-pos='H'}
:::
:::
...
::: {.cell-output-display}
![](index_files/figure-pdf/ftb-approx-1.png){fig-pos='H'}
:::
:::
...
[15] pillar_1.10.2             RColorBrewer_1.1-3       
[17] tzdb_0.5.0                rlang_1.1.6              
[19] stringi_1.8.7             xfun_0.52                
[21] timechange_0.3.0          cli_3.6.5                
[23] withr_3.0.2               magrittr_2.0.3           
[25] mountainmathHelpers_0.1.4 digest_0.6.37            
[27] grid_4.5.1                rstudioapi_0.17.1        
[29] hms_1.1.3                 lifecycle_1.0.4          
[31] vctrs_0.6.5               evaluate_1.0.4           
[33] glue_1.8.0                farver_2.1.2             
[35] RCurl_1.98-1.17           reshape2_1.4.4           
[37] rmarkdown_2.29            tools_4.5.1              
