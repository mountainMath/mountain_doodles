...
```{r fig-shelter-cost-per-room-by-rooms}
...
```{r fig-shelter-cost-per-room-adjusted}
...
```{r fig-shelter-cost-per-room-by-age}
pd_all_r |>
  filter_metros() |>
  filter(AGEGRP != "15 to 17 years") |>
  #filter(AGEGRP != "18 to 19 years") |>
...
```{r fig-shelter-cost-per-room-by-coarse-age}
...
```{r fig-shelter-cost-per-room-by-coarse-age-renter-movers}
...
```{r fig-shelter-cost-per-room-by-coarse-age-tenure}
...
```{r fig-shelter-cost-per-room-by-coarse-age-imputed-rent}
