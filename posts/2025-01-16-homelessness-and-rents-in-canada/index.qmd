...
```{r fig-homelessness-rate-best-guess}
homelessness_data_manual |>
  pivot_longer(all_of(homlessness_categories),names_to="category") |>
  mutate(category=gsub("_"," ",category)) |>
...
```{r fig-rent-homelessness-canada}
...
```{r fig-rent-homelessness-canada_single}
...
```{r fig-rent-distribution1, warning=FALSE, fig.height=6}
...
```{r fig-rents-med-vs-lower-decidle}
bind_rows(
  all_rents |> 
...
```{r crop=TRUE, include=FALSE}
ggplot() +
  annotate("label",x=1,y=0,label="high rents") +
  annotate("label",x=2,y=0,label="few spare bedrooms") +
  annotate("label",x=3,y=0,label="more homelessness") +
  annotate("curve",x=1.25,xend=1.65,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  annotate("curve",x=2.35,xend=2.6,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  theme_void() +
  theme(panel.background = ggplot2::element_rect(fill="#F8F4F0",colour=NA),
        plot.background = ggplot2::element_rect(fill="#F8F4F0")) +
  coord_fixed(xlim=c(0.8,3.4),ylim=c(-0.1,0.1)) +
  labs(x=NULL,y=NULL)
```
...
```{r crop=TRUE, include=FALSE}
ggplot() +
  annotate("label",x=1,y=0,label="low rents") +
  annotate("label",x=1.8,y=0,label="more spare bedrooms") +
  annotate("label",x=3,y=0,label="less homelessness, conditional on being poor") +
  annotate("curve",x=1.2,xend=1.45,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  annotate("curve",x=2.15,xend=2.3,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  theme_void() +
  theme(panel.background = ggplot2::element_rect(fill="#F8F4F0",colour=NA),
        plot.background = ggplot2::element_rect(fill="#F8F4F0")) +
  coord_fixed(xlim=c(0.9,3.7),ylim=c(-0.1,0.1)) +
  labs(x=NULL,y=NULL)
```
...
ggplot() +
  annotate("label",x=1,y=0,label="low rents") +
  annotate("label",x=1.85,y=0,label="low economic opportunity") +
  annotate("label",x=3,y=0,label="more (and different) poor people") +
  annotate("curve",x=1.2,xend=1.45,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"),end="first")) +
  annotate("curve",x=2.25,xend=2.5,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  theme_void() +
  theme(panel.background = ggplot2::element_rect(fill="#F8F4F0",colour=NA),
        plot.background = ggplot2::element_rect(fill="#F8F4F0")) +
  coord_fixed(xlim=c(0.9,3.45),ylim=c(-0.1,0.1)) +
  labs(x=NULL,y=NULL)
```
...
ggplot() +
  annotate("label",x=1,y=0,label="low rents") +
  annotate("label",x=1.85,y=0,label="low economic opportunity") +
  annotate("label",x=2.85,y=0,label="more empty bedrooms") +
  annotate("curve",x=1.2,xend=1.45,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"),end="first")) +
  annotate("curve",x=2.25,xend=2.5,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  theme_void() +
  theme(panel.background = ggplot2::element_rect(fill="#F8F4F0",colour=NA),
        plot.background = ggplot2::element_rect(fill="#F8F4F0")) +
  coord_fixed(xlim=c(0.9,3.15),ylim=c(-0.1,0.1)) +
  labs(x=NULL,y=NULL)
```
...
```{r crop=TRUE, include=FALSE}
ggplot() +
  annotate("label",x=1,y=0,label="few spare bedrooms") +
  annotate("label",x=1.85,y=0,label="high rates of doubling up") +
  annotate("label",x=2.55,y=0,label="high rents") +
  annotate("label",x=3.1,y=0,label="homelessness") +
  annotate("curve",x=1.3,xend=1.5,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"),end="first")) +
  annotate("curve",x=2.2,xend=2.37,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"),end="first")) +
  annotate("curve",x=2.7,xend=2.9,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  theme_void() +
  theme(panel.background = ggplot2::element_rect(fill="#F8F4F0",colour=NA),
        plot.background = ggplot2::element_rect(fill="#F8F4F0")) +
  coord_fixed(xlim=c(0.75,3.25),ylim=c(-0.1,0.1)) +
  labs(x=NULL,y=NULL)
```
...
ggplot() +
  annotate("label",x=1,y=0,label="high rents") +
  annotate("label",x=1.8,y=0,label="high rates of doubling up") +
  annotate("label",x=2.8,y=0,label="few spare bedrooms") +
  annotate("curve",x=1.2,xend=1.4,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  annotate("curve",x=2.2,xend=2.45,y=0,yend=0,curvature=0,arrow=arrow(length=unit(0.1,"in"))) +
  theme_void() +
  theme(panel.background = ggplot2::element_rect(fill="#F8F4F0",colour=NA),
        plot.background = ggplot2::element_rect(fill="#F8F4F0")) +
  coord_fixed(xlim=c(0.9,3),ylim=c(-0.1,0.1)) +
  labs(x=NULL,y=NULL)
```
...
```{r fig-homelessness-rents-mhu-brm}
...
```{r fig-homelessness-rents-mhu-brm_single}
