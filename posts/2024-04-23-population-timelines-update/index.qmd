...
As usual, the code for this post is [available on GitHub](https://github.com/mountainMath/doodles/blob/master/content/posts/2024-03-23-population-timeline-updates/index.Rmarkdown) for anyone to reproduce or adapt for their own purposes.
